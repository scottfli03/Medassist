...
namespace MedAssist.TestDataSetTableAdapters {
    ...
    public partial class TestsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tests] ([TestName]) VALUES (@TestName);\r\nSELECT TestID, TestNa" +
                "me FROM Tests WHERE (TestID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tests] SET [TestName] = @TestName WHERE (([TestID] = @Original_Test" +
                "ID) AND ([TestName] = @Original_TestName));\r\nSELECT TestID, TestName FROM Tests " +
                "WHERE (TestID = @TestID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT TestID, TestName FROM Tests WHERE (Inactive = 0)";
        ...
        public virtual int FillBy(TestDataSet.TestsDataTable dataTable) {
        ...
        public virtual int Update(string TestName, int Original_TestID, string Original_TestName, int TestID) {
            if ((TestName == null)) {
                throw new global::System.ArgumentNullException("TestName");
            }
            else {
        ...
        public virtual int Update(string TestName, int Original_TestID, string Original_TestName) {
            return this.Update(TestName, Original_TestID, Original_TestName, Original_TestID);
        }
    }
